...
async function main() {
  ...
  if (data.code !== 0) { console.error("错误:", data.message); process.exit(1) }
  ...
  fs.writeFileSync("bili-ruimai2.json", JSON.stringify(result, null, 2))
  console.log(`✅ 已保存 ${result.length} 条到 bili-ruimai2.json`)
